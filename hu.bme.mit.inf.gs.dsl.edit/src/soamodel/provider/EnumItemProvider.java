...
/**
 * This is the item provider adapter for a {@link soamodel.Enum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumItemProvider
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SoamodelPackage.Literals.ENUM__LITERALS);
		}
	...
	public String getText(Object object) {
		String label = ((soamodel.Enum)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(soamodel.Enum.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SoamodelPackage.Literals.ENUM__LITERALS,
				 SoamodelFactory.eINSTANCE.createEnumLiteral()));
	}
